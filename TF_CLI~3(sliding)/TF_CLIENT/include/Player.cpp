...
void CPlayer::Update(float fDeltaTime)
{
	...
	if (AnimState == MOVESTATE) {
		Rotate(Direction);
		xmf3Shift = Vector3::ScalarProduct( GetLook(), fDeltaTime * 10);
...
:CPlayer()
{
	...
	m_pOOBB = BoundingOrientedBox(XMFLOAT3(0.f, 0.f, 0.f), XMFLOAT3(3.f, 3.f, 3.f), XMFLOAT4(0, 0, 0, 1));
}
