...
//-----------------------------------------------------------------------------
#include "../include/Network/AutodetectMemoryLeak.h"
#include "stdafx.h"
#include "Object.h"
#include "Shader.h"
...
void CGameObject::AddObj(CGameObject * pObj)
{
	pObj->AddRef();
...
void CGameObject::EraseObject(CGameObject * pObj)
{
...
void CGameObject::EraseObject(const string & strTag)
{
