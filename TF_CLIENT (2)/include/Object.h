...
public:
	static void            AddObj(CGameObject* pObj);
	static CGameObject*    FindObject(const string& strTag);
	static void            EraseObject(CGameObject* pObj);
	static void            EraseObject(const string& strTag);
	static void            EraseObject();

	template <typename T>
	static T* CreateObj(const string& strTag, class CLayer* pLayer,ID3D12Device *pd3dDevice,ID3D12GraphicsCommandList *pd3dCommandList,ID3D12RootSignature *pd3dGraphicsRootSignature,int nMeshes = 1)
	{
		T* pObj = new T(pd3dDevice,pd3dCommandList,pd3dGraphicsRootSignature,nMeshes);
		pObj->SetTag(strTag);
		if (pLayer) {
...
public: //Get
	...
	XMFLOAT3                        GetWPosition() const { return(XMFLOAT3(m_xmf4x4World._41, m_xmf4x4World._42, m_xmf4x4World._43)); }
...
public: //Set
	...
	void                           SetWPosition(const XMFLOAT3& pos) { m_xmf4x4World._41 = pos.x; m_xmf4x4World._42 = pos.y; m_xmf4x4World._43 = pos.z; }
