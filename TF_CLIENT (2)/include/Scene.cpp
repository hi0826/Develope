...
//	if (m_LayerList.size() >= 2) { m_LayerList.sort(CScene::LayerSort); }
//	return pLayer;
//}
//
...
//		if (layer->GetTag() == strTag) return layer;
//
//	return NULL;
//}
//
...
CScene::~CScene()
{
	//Safe_Delete_VecList(m_LayerList); // SafeDelete 
}
